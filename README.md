...
```
app/src/main/java/com/todd-one/HelloController.java
```
...
**Important:** Replace the image placeholder `gcr.io/YOUR_PROJECT_ID/todd-one:latest` with your actual GCR or Artifact Registry path.
